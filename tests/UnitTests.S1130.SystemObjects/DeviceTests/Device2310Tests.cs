...
namespace UnitTests.S1130.SystemObjects.DeviceTests
{
	public class Device2310Tests : DeviceTestBase
	{
		...
		private static ushort GetCurrentStatus(ICartridge cart)         // Get the current cartridge status
			=> (ushort)(cart.CurrentCylinder == 0 ? Device2310.AtCylZero : 0); // return indicator for cylinder zero
