    ...
    public class InstructionFormatValidation
    {
        ...
        private List<InstructionTest> GetAllInstructionTests()
        {
            ...
            tests.Add(new InstructionTest
            {
                ...
                ExpectedHex = new[] { Short(OpCodes.Load, 0, 0x0040) },
            ...
            {
                Mnemonic = "LD",
                AssemblerFormat = "         LD |1|/0040",
                ExpectedHex = new[] { Short(OpCodes.Load, 1, 0x0040) },
            ...
            {
                Mnemonic = "LD",
                AssemblerFormat = "         LD |2|/0040",
                ExpectedHex = new[] { Short(OpCodes.Load, 2, 0x0040) },
            ...
            {
                Mnemonic = "LD",
                AssemblerFormat = "         LD |3|/0040",
                ExpectedHex = new[] { Short(OpCodes.Load, 3, 0x0040) },
            ...
            {
                Mnemonic = "LDD",
                AssemblerFormat = "         LDD /0040",
                ExpectedHex = new[] { Short(OpCodes.LoadDouble, 0, 0x0040) },
            ...
            {
                Mnemonic = "STO",
                AssemblerFormat = "         STO /0040",
                ExpectedHex = new[] { Short(OpCodes.Store, 0, 0x0040) },
            ...
            {
                Mnemonic = "STD",
                AssemblerFormat = "         STD /0040",
                ExpectedHex = new[] { Short(OpCodes.StoreDouble, 0, 0x0040) },
            ...
            {
                Mnemonic = "A",
                AssemblerFormat = "         A /0040",
                ExpectedHex = new[] { Short(OpCodes.Add, 0, 0x0040) },
            ...
            {
                Mnemonic = "AD",
                AssemblerFormat = "         AD /0040",
                ExpectedHex = new[] { Short(OpCodes.AddDouble, 0, 0x0040) },
            ...
            {
                Mnemonic = "S",
                AssemblerFormat = "         S /0040",
                ExpectedHex = new[] { Short(OpCodes.Subtract, 0, 0x0040) },
            ...
            {
                Mnemonic = "SD",
                AssemblerFormat = "         SD /0040",
                ExpectedHex = new[] { Short(OpCodes.SubtractDouble, 0, 0x0040) },
            ...
            {
                Mnemonic = "M",
                AssemblerFormat = "         M /0040",
                ExpectedHex = new[] { Short(OpCodes.Multiply, 0, 0x0040) },
            ...
            {
                Mnemonic = "D",
                AssemblerFormat = "         D /0040",
                ExpectedHex = new[] { Short(OpCodes.Divide, 0, 0x0040) },
            ...
            {
                Mnemonic = "AND",
                AssemblerFormat = "         AND /0040",
                ExpectedHex = new[] { Short(OpCodes.And, 0, 0x0040) },
            ...
            {
                Mnemonic = "OR",
                AssemblerFormat = "         OR /0040",
                ExpectedHex = new[] { Short(OpCodes.Or, 0, 0x0040) },
            ...
            {
                Mnemonic = "EOR",
                AssemblerFormat = "         EOR /0040",
                ExpectedHex = new[] { Short(OpCodes.ExclusiveOr, 0, 0x0040) },
            ...
            {
                Mnemonic = "LDX",
                AssemblerFormat = "         LDX |1|/0040",
                ExpectedHex = new[] { Short(OpCodes.LoadIndex, 1, 0x0040) },
            ...
            {
                Mnemonic = "LDX",
                AssemblerFormat = "         LDX |2|/0040",
                ExpectedHex = new[] { Short(OpCodes.LoadIndex, 2, 0x0040) },
            ...
            {
                Mnemonic = "LDX",
                AssemblerFormat = "         LDX |3|/0040",
                ExpectedHex = new[] { Short(OpCodes.LoadIndex, 3, 0x0040) },
            ...
            {
                Mnemonic = "STX",
                AssemblerFormat = "         STX |1|/0040",
                ExpectedHex = new[] { Short(OpCodes.StoreIndex, 1, 0x0040) },
            ...
            {
                Mnemonic = "MDX",
                AssemblerFormat = "         MDX |1|/0040",
                ExpectedHex = new[] { Short(OpCodes.ModifyIndex, 1, 0x0040) },
            ...
            {
                Mnemonic = "STS",
                AssemblerFormat = "         STS /0040",
                ExpectedHex = new[] { Short(OpCodes.StoreStatus, 0, 0x0040) },
